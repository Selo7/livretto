...
export function Toolbar({ editor, isDictating, onToggleDictation, onImportar, onTransformToChapter, onOpenRodape, onOpenBuscar, onInsertImage, defaultFontId }: ToolbarProps) {
  ...
  const selectClass = 'h-7 rounded-md border border-border bg-background text-xs text-muted-foreground px-1.5 cursor-pointer hover:bg-accent focus:outline-none transition-colors'
